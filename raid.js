...
client.on('ready', () => {
    client.user.setActivity('Anti Wizzer', { type: 'PLAYING' });
    console.clear();
 
  console.log('\n\x1b[32m%s\x1b[0m', `          $[INFO]: Logged on ${client.user.tag}`);  
  console.log('\x1b[32m%s\x1b[0m', `           $[INFO]: PREFIX ${mainprefix}`);  
  console.log('\x1b[32m%s\x1b[0m', `           $[EXTRA]: Discord ANIT-WIZZ`);  

   console.log('\x1b[31m%s\x1b[0m', `            $[CREDITS]: Made By Zuskii/Xukoo`);  
  console.log('\x1b[31m%s\x1b[0m', `            $[SUPPORT]: Zuskii's Hood: https://discord.gg/a25MdChX `);  
